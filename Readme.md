...
Projeyi bilgisayarına indir veya klonla, ardından `index.html` dosyasını herhangi bir tarayıcıda aç:

```bash
git clone https://github.com/BatuhanKlcky/sanalbahce.git
cd sanalbahce
```
